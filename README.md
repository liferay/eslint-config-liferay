...
| [liferay-portal/deprecation](./plugins/eslint-plugin-liferay-portal/docs/rules/deprecation.md)                                          | liferay/portal               | [\#55](https://github.com/liferay/eslint-config-liferay/pull/55)                                                                   |
...
| [liferay/no-arrow](./plugins/eslint-plugin-liferay/docs/rules/no-arrow.md)                                                              | liferay                      | [\#179](https://github.com/liferay/eslint-config-liferay/issues/179)                                                               |
...
-   [liferay/no-arrow](./plugins/eslint-plugin-liferay/docs/rules/no-arrow.md): Bans arrow functions (for IE; not on by default).
...
-   [liferay-portal/deprecation](./plugins/eslint-plugin-liferay-portal/docs/rules/deprecation.md): Enforces standard formatting of `@deprecated` annotations.
